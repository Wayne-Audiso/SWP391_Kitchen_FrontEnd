          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, ingredientName: e.target.value }))
                }
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, storageCondition: e.target.value }))
                }
              />
            </div>
          </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deleteTarget?.ingredientName}</strong>? This action
              cannot be undone and will also remove it from all recipes.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
